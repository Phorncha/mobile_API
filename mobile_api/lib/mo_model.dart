...
moModel? moModelFromJson(String str) => moModel.fromJson(json.decode(str));

String moModelToJson(moModel? data) => json.encode(data!.toJson());
...
class moModel {
  ...
  moModel.fromJson(Map<String, dynamic> json) {
    name = json['name'];
    height = json['height'];
    mass = json['mass'];
